...
function addMealToFav(mealData) {
  ...
  const btnLi = favMeal.querySelector(".clear");
  // Error Uncaught (in promise) ReferenceError: favMeal is not defined
  ...
  btnLi.addEventListener("click", () => {
    ...
    // btnLi.addEventListener("click", () => {
    //   // removeLiFromFav(mealData.idMeal);
    //   favoriteContainer.removeChild(liId); // not an object.
    //   removeMealFromLocalStorage(liId);
  });

  favoriteContainer.appendChild(favMeal);
}

// function removeLiFromFav(favId) {
//   favoriteContainer.removeChild(favId);
//   removeMealFromLocalStorage(mealId);
// }

// to be called when removing from Fav Li
// function removeLiFromFav(favId) {
//   console.log(favId); // id is passed.
// call removeMealFromLocalStorage(mealId)
//   const liToBeRemove = document.getElementById("favId"); //selete the li
//   liToBeRemove.remove(); //delete the li
//   removeMealFromLocalStorage(favId); // remove from LS
//
// Why to I get "toBeRemove is null" when I create this function?

//const favMealClass = document.getElementByClassName("fav-meals");
// favoriteContainer.removeChild(favId);
//  favMeal.classList.add("fav-meal");
